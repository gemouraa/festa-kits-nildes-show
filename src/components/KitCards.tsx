    ...
    >
      <Card className="h-full overflow-hidden transition-all duration-300 bg-white border-none shadow-lg">
        <CardHeader className="relative bg-gradient-to-r from-sky-400 to-purple-400">
          ...
          <CardTitle className="text-xl font-bold text-center text-white">{kit.name}</CardTitle>
        </CardHeader>
        ...
        <CardFooter>
          <Button 
            ...
            className="w-full gap-2 text-white transition-all duration-300 shadow-md bg-green-600 hover:bg-green-700 hover:shadow-lg"
          >
